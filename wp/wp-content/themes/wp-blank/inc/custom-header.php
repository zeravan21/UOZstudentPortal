 ...
 * @uses wp_blank_theme_header_style() to style front-end.
 * @uses wp_blank_theme_admin_header_style() to style wp-admin form.
 * @uses wp_blank_theme_admin_header_image() to add custom markup to wp-admin form.
...
function wp_blank_theme_custom_header_setup() {
	$args = array(
		...
		'admin-head-callback'    => 'wp_blank_theme_admin_header_style',
		'admin-preview-callback' => 'wp_blank_theme_admin_header_image',
	);
	...
	register_default_headers( array(
		'circle' => array(
			...
			'description'   => _x( 'Circle', 'header image description', 'wp-blank' )
		),
		'diamond' => array(
			'url'           => '%s/images/headers/diamond.png',
			'thumbnail_url' => '%s/images/headers/diamond-thumbnail.png',
			'description'   => _x( 'Diamond', 'header image description', 'wp-blank' )
		),
		'star' => array(
			'url'           => '%s/images/headers/star.png',
			'thumbnail_url' => '%s/images/headers/star-thumbnail.png',
			'description'   => _x( 'Star', 'header image description', 'wp-blank' )
		),
	) );
}
add_action( 'after_setup_theme', 'wp_blank_theme_custom_header_setup', 11 );
...
function wp_blank_theme_header_style() {
	...
	?>
	<style type="text/css" id="wp_blank-header-css">
 ...
 * @return void
 */
function wp_blank_theme_admin_header_style() {
	$header_image = get_header_image();?>
	<style type="text/css" id="wp_blank-admin-header-css">
 ...
 * @return void
 */
function wp_blank_theme_admin_header_image() { ?>
